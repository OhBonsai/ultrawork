export const dict = {
  ...
  "settingsV2.popover.title": "Configuración",
  "settingsV2.popover.settings": "Configuración",
  "settingsV2.popover.language": "Cambiar idioma",
  "settingsV2.popover.workspace": "Directorio de trabajo",
  "settingsV2.popover.providers": "Modelos (Proveedores)",
  "settingsV2.popover.channels": "Canales de mensajes",
  "settingsV2.popover.remote": "Conexión remota",
  "settingsV2.popover.help": "Documentación de ayuda",
  "settingsV2.popover.about": "Acerca de nosotros",
  "settingsV2.popover.comingSoon": "Próximamente",
  "settingsV2.tab.general": "General",
  "settingsV2.tab.privacy": "Privacidad",
  "settingsV2.tab.capabilities": "Configuración de capacidades",
  "settingsV2.comingSoon": "Próximamente",
  "settingsV2.general.title": "Configuración general",
  "settingsV2.general.section.profile": "Perfil",
  "settingsV2.general.row.fullName.title": "Nombre completo",
  "settingsV2.general.row.fullName.description": "Su nombre para mostrar",
  "settingsV2.general.row.fullName.placeholder": "Ingrese nombre completo",
  "settingsV2.general.row.nickname.title": "Apodo",
  "settingsV2.general.row.nickname.description": "Un nombre corto mostrado en la barra lateral",
  "settingsV2.general.row.nickname.placeholder": "Ingrese apodo",
  "settingsV2.general.row.workScene.title": "Escenario de trabajo",
  "settingsV2.general.row.workScene.description": "Su escenario de trabajo principal",
  "settingsV2.general.workScene.none": "No establecido",
  "settingsV2.general.workScene.development": "Desarrollo",
  "settingsV2.general.workScene.writing": "Escritura",
  "settingsV2.general.workScene.research": "Investigación",
  "settingsV2.general.workScene.design": "Diseño",
  "settingsV2.general.workScene.other": "Otro",
  "settingsV2.privacy.title": "Privacidad",
  "settingsV2.privacy.placeholder": "La configuración de privacidad estará disponible en una futura actualización.",
  "settingsV2.capabilities.title": "Configuración de capacidades",
  "settingsV2.capabilities.placeholder": "La configuración de capacidades estará disponible en una futura actualización.",
}
