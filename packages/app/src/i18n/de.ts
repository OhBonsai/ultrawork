...
export const dict = {
  ...
  "settingsV2.popover.title": "Einstellungen",
  "settingsV2.popover.settings": "Einstellungen",
  "settingsV2.popover.language": "Sprache wechseln",
  "settingsV2.popover.workspace": "Arbeitsverzeichnis",
  "settingsV2.popover.providers": "Modelle (Anbieter)",
  "settingsV2.popover.channels": "Nachrichtenkanäle",
  "settingsV2.popover.remote": "Remote-Verbindung",
  "settingsV2.popover.help": "Hilfedokumentation",
  "settingsV2.popover.about": "Über uns",
  "settingsV2.popover.comingSoon": "Demnächst verfügbar",
  "settingsV2.tab.general": "Allgemein",
  "settingsV2.tab.privacy": "Datenschutz",
  "settingsV2.tab.capabilities": "Funktionskonfiguration",
  "settingsV2.comingSoon": "Demnächst verfügbar",
  "settingsV2.general.title": "Allgemeine Einstellungen",
  "settingsV2.general.section.profile": "Profil",
  "settingsV2.general.row.fullName.title": "Vollständiger Name",
  "settingsV2.general.row.fullName.description": "Ihr Anzeigename",
  "settingsV2.general.row.fullName.placeholder": "Vollständigen Namen eingeben",
  "settingsV2.general.row.nickname.title": "Spitzname",
  "settingsV2.general.row.nickname.description": "Ein kurzer Name in der Seitenleiste",
  "settingsV2.general.row.nickname.placeholder": "Spitznamen eingeben",
  "settingsV2.general.row.workScene.title": "Arbeitsszenario",
  "settingsV2.general.row.workScene.description": "Ihr hauptsächliches Arbeitsszenario",
  "settingsV2.general.workScene.none": "Nicht festgelegt",
  "settingsV2.general.workScene.development": "Entwicklung",
  "settingsV2.general.workScene.writing": "Schreiben",
  "settingsV2.general.workScene.research": "Forschung",
  "settingsV2.general.workScene.design": "Design",
  "settingsV2.general.workScene.other": "Sonstiges",
  "settingsV2.privacy.title": "Datenschutz",
  "settingsV2.privacy.placeholder": "Datenschutzeinstellungen werden in einem zukünftigen Update verfügbar sein.",
  "settingsV2.capabilities.title": "Funktionskonfiguration",
  "settingsV2.capabilities.placeholder": "Funktionskonfiguration wird in einem zukünftigen Update verfügbar sein.",
