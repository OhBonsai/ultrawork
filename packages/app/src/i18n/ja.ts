export const dict = {
  ...
  "settingsV2.popover.title": "設定",
  "settingsV2.popover.settings": "設定",
  "settingsV2.popover.language": "言語切替",
  "settingsV2.popover.workspace": "作業ディレクトリ",
  "settingsV2.popover.providers": "モデル（プロバイダー）",
  "settingsV2.popover.channels": "メッセージチャンネル",
  "settingsV2.popover.remote": "リモートサービス接続",
  "settingsV2.popover.help": "ヘルプドキュメント",
  "settingsV2.popover.about": "このアプリについて",
  "settingsV2.popover.comingSoon": "近日公開",
  "settingsV2.tab.general": "一般",
  "settingsV2.tab.privacy": "プライバシー",
  "settingsV2.tab.capabilities": "機能設定",
  "settingsV2.comingSoon": "近日公開",
  "settingsV2.general.title": "一般設定",
  "settingsV2.general.section.profile": "プロフィール",
  "settingsV2.general.row.fullName.title": "フルネーム",
  "settingsV2.general.row.fullName.description": "表示用のフルネーム",
  "settingsV2.general.row.fullName.placeholder": "フルネームを入力",
  "settingsV2.general.row.nickname.title": "ニックネーム",
  "settingsV2.general.row.nickname.description": "サイドバーに表示される短い名前",
  "settingsV2.general.row.nickname.placeholder": "ニックネームを入力",
  "settingsV2.general.row.workScene.title": "作業シーン",
  "settingsV2.general.row.workScene.description": "主な作業シナリオ",
  "settingsV2.general.workScene.none": "未設定",
  "settingsV2.general.workScene.development": "開発",
  "settingsV2.general.workScene.writing": "執筆",
  "settingsV2.general.workScene.research": "研究",
  "settingsV2.general.workScene.design": "デザイン",
  "settingsV2.general.workScene.other": "その他",
  "settingsV2.privacy.title": "プライバシー",
  "settingsV2.privacy.placeholder": "プライバシー設定は今後のアップデートで利用可能になります。",
  "settingsV2.capabilities.title": "機能設定",
  "settingsV2.capabilities.placeholder": "機能設定は今後のアップデートで利用可能になります。",
}
