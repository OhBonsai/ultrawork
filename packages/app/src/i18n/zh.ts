...
export const dict = {
  ...
  // Settings V2
  "settingsV2.tab.general": "通用",
  "settingsV2.tab.privacy": "隐私",
  "settingsV2.tab.capabilities": "能力配置",
  "settingsV2.comingSoon": "即将上线",

  "settingsV2.general.title": "通用设置",
  "settingsV2.general.section.profile": "个人资料",
  "settingsV2.general.row.fullName.title": "全称",
  "settingsV2.general.row.fullName.description": "您的显示名称",
  "settingsV2.general.row.fullName.placeholder": "输入全称",
  "settingsV2.general.row.nickname.title": "昵称",
  "settingsV2.general.row.nickname.description": "显示在侧边栏的简短名称",
  "settingsV2.general.row.nickname.placeholder": "输入昵称",
  "settingsV2.general.row.workScene.title": "工作场景",
  "settingsV2.general.row.workScene.description": "您的主要工作场景",
  "settingsV2.general.workScene.none": "未设置",
  "settingsV2.general.workScene.development": "开发",
  "settingsV2.general.workScene.writing": "写作",
  "settingsV2.general.workScene.research": "研究",
  "settingsV2.general.workScene.design": "设计",
  "settingsV2.general.workScene.other": "其他",

  "settingsV2.privacy.title": "隐私",
  "settingsV2.privacy.placeholder": "隐私设置将在后续版本中提供。",

  "settingsV2.capabilities.title": "能力配置",
  "settingsV2.capabilities.placeholder": "能力配置将在后续版本中提供。",

  "settingsV2.popover.title": "设置",
  "settingsV2.popover.settings": "设置",
  "settingsV2.popover.language": "语言切换",
  "settingsV2.popover.workspace": "工作目录",
  "settingsV2.popover.providers": "模型（供应商）",
  "settingsV2.popover.channels": "消息通道",
  "settingsV2.popover.remote": "远程服务连接",
