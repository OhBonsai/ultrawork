export const dict = {
  ...
  "settingsV2.popover.title": "الإعدادات",
  "settingsV2.popover.settings": "الإعدادات",
  "settingsV2.popover.language": "تبديل اللغة",
  "settingsV2.popover.workspace": "دليل العمل",
  "settingsV2.popover.providers": "النماذج (الموردون)",
  "settingsV2.popover.channels": "قنوات الرسائل",
  "settingsV2.popover.remote": "اتصال عن بُعد",
  "settingsV2.popover.help": "وثائق المساعدة",
  "settingsV2.popover.about": "من نحن",
  "settingsV2.popover.comingSoon": "قريباً",
  "settingsV2.tab.general": "عام",
  "settingsV2.tab.privacy": "الخصوصية",
  "settingsV2.tab.capabilities": "تكوين القدرات",
  "settingsV2.comingSoon": "قريباً",
  "settingsV2.general.title": "الإعدادات العامة",
  "settingsV2.general.section.profile": "الملف الشخصي",
  "settingsV2.general.row.fullName.title": "الاسم الكامل",
  "settingsV2.general.row.fullName.description": "اسمك المعروض",
  "settingsV2.general.row.fullName.placeholder": "أدخل الاسم الكامل",
  "settingsV2.general.row.nickname.title": "الكنية",
  "settingsV2.general.row.nickname.description": "اسم قصير يظهر في الشريط الجانبي",
  "settingsV2.general.row.nickname.placeholder": "أدخل الكنية",
  "settingsV2.general.row.workScene.title": "سيناريو العمل",
  "settingsV2.general.row.workScene.description": "سيناريو العمل الرئيسي",
  "settingsV2.general.workScene.none": "غير محدد",
  "settingsV2.general.workScene.development": "تطوير",
  "settingsV2.general.workScene.writing": "كتابة",
  "settingsV2.general.workScene.research": "بحث",
  "settingsV2.general.workScene.design": "تصميم",
  "settingsV2.general.workScene.other": "أخرى",
  "settingsV2.privacy.title": "الخصوصية",
  "settingsV2.privacy.placeholder": "ستكون إعدادات الخصوصية متاحة في تحديث مستقبلي.",
  "settingsV2.capabilities.title": "تكوين القدرات",
  "settingsV2.capabilities.placeholder": "سيكون تكوين القدرات متاحاً في تحديث مستقبلي.",
}
