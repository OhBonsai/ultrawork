...
export const dict = {
  ...
  "settingsV2.popover.title": "설정",
  "settingsV2.popover.settings": "설정",
  "settingsV2.popover.language": "언어 전환",
  "settingsV2.popover.workspace": "작업 디렉토리",
  "settingsV2.popover.providers": "모델 (공급자)",
  "settingsV2.popover.channels": "메시지 채널",
  "settingsV2.popover.remote": "원격 서비스 연결",
  "settingsV2.popover.help": "도움말",
  "settingsV2.popover.about": "정보",
  "settingsV2.popover.comingSoon": "준비 중",
  "settingsV2.tab.general": "일반",
  "settingsV2.tab.privacy": "개인정보",
  "settingsV2.tab.capabilities": "기능 설정",
  "settingsV2.comingSoon": "준비 중",
  "settingsV2.general.title": "일반 설정",
  "settingsV2.general.section.profile": "프로필",
  "settingsV2.general.row.fullName.title": "전체 이름",
  "settingsV2.general.row.fullName.description": "표시용 전체 이름",
  "settingsV2.general.row.fullName.placeholder": "전체 이름 입력",
  "settingsV2.general.row.nickname.title": "닉네임",
  "settingsV2.general.row.nickname.description": "사이드바에 표시되는 짧은 이름",
  "settingsV2.general.row.nickname.placeholder": "닉네임 입력",
  "settingsV2.general.row.workScene.title": "작업 시나리오",
  "settingsV2.general.row.workScene.description": "주요 작업 시나리오",
  "settingsV2.general.workScene.none": "미설정",
  "settingsV2.general.workScene.development": "개발",
  "settingsV2.general.workScene.writing": "글쓰기",
  "settingsV2.general.workScene.research": "연구",
  "settingsV2.general.workScene.design": "디자인",
  "settingsV2.general.workScene.other": "기타",
  "settingsV2.privacy.title": "개인정보",
  "settingsV2.privacy.placeholder": "개인정보 설정은 향후 업데이트에서 제공됩니다.",
  "settingsV2.capabilities.title": "기능 설정",
  "settingsV2.capabilities.placeholder": "기능 설정은 향후 업데이트에서 제공됩니다.",
}
