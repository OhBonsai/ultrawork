export const dict = {
  ...
  "settingsV2.popover.title": "Configurações",
  "settingsV2.popover.settings": "Configurações",
  "settingsV2.popover.language": "Trocar idioma",
  "settingsV2.popover.workspace": "Diretório de trabalho",
  "settingsV2.popover.providers": "Modelos (Provedores)",
  "settingsV2.popover.channels": "Canais de mensagens",
  "settingsV2.popover.remote": "Conexão remota",
  "settingsV2.popover.help": "Documentação de ajuda",
  "settingsV2.popover.about": "Sobre nós",
  "settingsV2.popover.comingSoon": "Em breve",
  "settingsV2.tab.general": "Geral",
  "settingsV2.tab.privacy": "Privacidade",
  "settingsV2.tab.capabilities": "Configuração de capacidades",
  "settingsV2.comingSoon": "Em breve",
  "settingsV2.general.title": "Configurações gerais",
  "settingsV2.general.section.profile": "Perfil",
  "settingsV2.general.row.fullName.title": "Nome completo",
  "settingsV2.general.row.fullName.description": "Seu nome de exibição",
  "settingsV2.general.row.fullName.placeholder": "Digite o nome completo",
  "settingsV2.general.row.nickname.title": "Apelido",
  "settingsV2.general.row.nickname.description": "Um nome curto exibido na barra lateral",
  "settingsV2.general.row.nickname.placeholder": "Digite o apelido",
  "settingsV2.general.row.workScene.title": "Cenário de trabalho",
  "settingsV2.general.row.workScene.description": "Seu cenário de trabalho principal",
  "settingsV2.general.workScene.none": "Não definido",
  "settingsV2.general.workScene.development": "Desenvolvimento",
  "settingsV2.general.workScene.writing": "Escrita",
  "settingsV2.general.workScene.research": "Pesquisa",
  "settingsV2.general.workScene.design": "Design",
  "settingsV2.general.workScene.other": "Outro",
  "settingsV2.privacy.title": "Privacidade",
  "settingsV2.privacy.placeholder": "As configurações de privacidade estarão disponíveis em uma atualização futura.",
  "settingsV2.capabilities.title": "Configuração de capacidades",
  "settingsV2.capabilities.placeholder": "A configuração de capacidades estará disponível em uma atualização futura.",
}
