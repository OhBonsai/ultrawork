export const dict = {
  ...
  "settingsV2.popover.title": "Indstillinger",
  "settingsV2.popover.settings": "Indstillinger",
  "settingsV2.popover.language": "Skift sprog",
  "settingsV2.popover.workspace": "Arbejdsmappe",
  "settingsV2.popover.providers": "Modeller (Udbydere)",
  "settingsV2.popover.channels": "Beskedkanaler",
  "settingsV2.popover.remote": "Fjernforbindelse",
  "settingsV2.popover.help": "Hjælpedokumentation",
  "settingsV2.popover.about": "Om os",
  "settingsV2.popover.comingSoon": "Kommer snart",
  "settingsV2.tab.general": "Generelt",
  "settingsV2.tab.privacy": "Privatliv",
  "settingsV2.tab.capabilities": "Funktionskonfiguration",
  "settingsV2.comingSoon": "Kommer snart",
  "settingsV2.general.title": "Generelle indstillinger",
  "settingsV2.general.section.profile": "Profil",
  "settingsV2.general.row.fullName.title": "Fulde navn",
  "settingsV2.general.row.fullName.description": "Dit visningsnavn",
  "settingsV2.general.row.fullName.placeholder": "Indtast fulde navn",
  "settingsV2.general.row.nickname.title": "Kaldenavn",
  "settingsV2.general.row.nickname.description": "Et kort navn vist i sidebjælken",
  "settingsV2.general.row.nickname.placeholder": "Indtast kaldenavn",
  "settingsV2.general.row.workScene.title": "Arbejdsscenarie",
  "settingsV2.general.row.workScene.description": "Dit primære arbejdsscenarie",
  "settingsV2.general.workScene.none": "Ikke angivet",
  "settingsV2.general.workScene.development": "Udvikling",
  "settingsV2.general.workScene.writing": "Skrivning",
  "settingsV2.general.workScene.research": "Forskning",
  "settingsV2.general.workScene.design": "Design",
  "settingsV2.general.workScene.other": "Andet",
  "settingsV2.privacy.title": "Privatliv",
  "settingsV2.privacy.placeholder": "Privatlivsindstillinger vil være tilgængelige i en fremtidig opdatering.",
  "settingsV2.capabilities.title": "Funktionskonfiguration",
  "settingsV2.capabilities.placeholder": "Funktionskonfiguration vil være tilgængelig i en fremtidig opdatering.",
}
