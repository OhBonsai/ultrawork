...
export const dict = {
  ...
  "settingsV2.popover.language": "語言切換",
  "settingsV2.popover.workspace": "工作目錄",
  "settingsV2.popover.providers": "模型（供應商）",
  "settingsV2.popover.channels": "訊息通道",
  "settingsV2.popover.remote": "遠端服務連線",
  "settingsV2.popover.help": "幫助文件",
  "settingsV2.popover.about": "關於我們",
  "settingsV2.popover.comingSoon": "即將上線",
  "settingsV2.tab.general": "一般",
  "settingsV2.tab.privacy": "隱私",
  "settingsV2.tab.capabilities": "功能配置",
  "settingsV2.comingSoon": "即將上線",
  "settingsV2.general.title": "一般設定",
  "settingsV2.general.section.profile": "個人資料",
  "settingsV2.general.row.fullName.title": "全名",
  "settingsV2.general.row.fullName.description": "您的顯示名稱",
  "settingsV2.general.row.fullName.placeholder": "輸入全名",
  "settingsV2.general.row.nickname.title": "暱稱",
  "settingsV2.general.row.nickname.description": "顯示在側邊欄的簡短名稱",
  "settingsV2.general.row.nickname.placeholder": "輸入暱稱",
  "settingsV2.general.row.workScene.title": "工作場景",
  "settingsV2.general.row.workScene.description": "您的主要工作場景",
  "settingsV2.general.workScene.none": "未設定",
  "settingsV2.general.workScene.development": "開發",
  "settingsV2.general.workScene.writing": "寫作",
  "settingsV2.general.workScene.research": "研究",
  "settingsV2.general.workScene.design": "設計",
  "settingsV2.general.workScene.other": "其他",
  "settingsV2.privacy.title": "隱私",
  "settingsV2.privacy.placeholder": "隱私設定將在後續版本中提供。",
  "settingsV2.capabilities.title": "功能配置",
  "settingsV2.capabilities.placeholder": "功能配置將在後續版本中提供。",
