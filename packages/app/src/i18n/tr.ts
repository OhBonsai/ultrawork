...
export const dict = {
  ...
  "settingsV2.popover.title": "Ayarlar",
  "settingsV2.popover.settings": "Ayarlar",
  "settingsV2.popover.language": "Dil değiştir",
  "settingsV2.popover.workspace": "Çalışma dizini",
  "settingsV2.popover.providers": "Modeller (Sağlayıcılar)",
  "settingsV2.popover.channels": "Mesaj kanalları",
  "settingsV2.popover.remote": "Uzak bağlantı",
  "settingsV2.popover.help": "Yardım belgeleri",
  "settingsV2.popover.about": "Hakkımızda",
  "settingsV2.popover.comingSoon": "Yakında",
  "settingsV2.tab.general": "Genel",
  "settingsV2.tab.privacy": "Gizlilik",
  "settingsV2.tab.capabilities": "Yetenek yapılandırması",
  "settingsV2.comingSoon": "Yakında",
  "settingsV2.general.title": "Genel ayarlar",
  "settingsV2.general.section.profile": "Profil",
  "settingsV2.general.row.fullName.title": "Tam ad",
  "settingsV2.general.row.fullName.description": "Görüntülenecek tam adınız",
  "settingsV2.general.row.fullName.placeholder": "Tam adı girin",
  "settingsV2.general.row.nickname.title": "Takma ad",
  "settingsV2.general.row.nickname.description": "Kenar çubuğunda gösterilen kısa ad",
  "settingsV2.general.row.nickname.placeholder": "Takma adı girin",
  "settingsV2.general.row.workScene.title": "Çalışma senaryosu",
  "settingsV2.general.row.workScene.description": "Ana çalışma senaryonuz",
  "settingsV2.general.workScene.none": "Belirlenmedi",
  "settingsV2.general.workScene.development": "Geliştirme",
  "settingsV2.general.workScene.writing": "Yazma",
  "settingsV2.general.workScene.research": "Araştırma",
  "settingsV2.general.workScene.design": "Tasarım",
  "settingsV2.general.workScene.other": "Diğer",
  "settingsV2.privacy.title": "Gizlilik",
  "settingsV2.privacy.placeholder": "Gizlilik ayarları gelecek bir güncellemede mevcut olacak.",
  "settingsV2.capabilities.title": "Yetenek yapılandırması",
  "settingsV2.capabilities.placeholder": "Yetenek yapılandırması gelecek bir güncellemede mevcut olacak.",
