export const dict = {
  ...
  "settingsV2.popover.title": "การตั้งค่า",
  "settingsV2.popover.settings": "การตั้งค่า",
  "settingsV2.popover.language": "เปลี่ยนภาษา",
  "settingsV2.popover.workspace": "ไดเรกทอรีทำงาน",
  "settingsV2.popover.providers": "โมเดล (ผู้ให้บริการ)",
  "settingsV2.popover.channels": "ช่องทางข้อความ",
  "settingsV2.popover.remote": "การเชื่อมต่อระยะไกล",
  "settingsV2.popover.help": "เอกสารช่วยเหลือ",
  "settingsV2.popover.about": "เกี่ยวกับเรา",
  "settingsV2.popover.comingSoon": "เร็วๆ นี้",
  "settingsV2.tab.general": "ทั่วไป",
  "settingsV2.tab.privacy": "ความเป็นส่วนตัว",
  "settingsV2.tab.capabilities": "การกำหนดค่าความสามารถ",
  "settingsV2.comingSoon": "เร็วๆ นี้",
  "settingsV2.general.title": "การตั้งค่าทั่วไป",
  "settingsV2.general.section.profile": "โปรไฟล์",
  "settingsV2.general.row.fullName.title": "ชื่อเต็ม",
  "settingsV2.general.row.fullName.description": "ชื่อที่แสดงของคุณ",
  "settingsV2.general.row.fullName.placeholder": "กรอกชื่อเต็ม",
  "settingsV2.general.row.nickname.title": "ชื่อเล่น",
  "settingsV2.general.row.nickname.description": "ชื่อสั้นที่แสดงในแถบด้านข้าง",
  "settingsV2.general.row.nickname.placeholder": "กรอกชื่อเล่น",
  "settingsV2.general.row.workScene.title": "สถานการณ์การทำงาน",
  "settingsV2.general.row.workScene.description": "สถานการณ์การทำงานหลักของคุณ",
  "settingsV2.general.workScene.none": "ยังไม่ได้ตั้งค่า",
  "settingsV2.general.workScene.development": "พัฒนา",
  "settingsV2.general.workScene.writing": "เขียน",
  "settingsV2.general.workScene.research": "วิจัย",
  "settingsV2.general.workScene.design": "ออกแบบ",
  "settingsV2.general.workScene.other": "อื่นๆ",
  "settingsV2.privacy.title": "ความเป็นส่วนตัว",
  "settingsV2.privacy.placeholder": "การตั้งค่าความเป็นส่วนตัวจะพร้อมใช้งานในการอัปเดตในอนาคต",
  "settingsV2.capabilities.title": "การกำหนดค่าความสามารถ",
  "settingsV2.capabilities.placeholder": "การกำหนดค่าความสามารถจะพร้อมใช้งานในการอัปเดตในอนาคต",
}
