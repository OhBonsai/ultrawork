...
export const dict = {
  ...
  "settingsV2.popover.title": "Innstillinger",
  "settingsV2.popover.settings": "Innstillinger",
  "settingsV2.popover.language": "Bytt språk",
  "settingsV2.popover.workspace": "Arbeidskatalog",
  "settingsV2.popover.providers": "Modeller (Leverandører)",
  "settingsV2.popover.channels": "Meldingskanaler",
  "settingsV2.popover.remote": "Fjerntilkobling",
  "settingsV2.popover.help": "Hjelpedokumentasjon",
  "settingsV2.popover.about": "Om oss",
  "settingsV2.popover.comingSoon": "Kommer snart",
  "settingsV2.tab.general": "Generelt",
  "settingsV2.tab.privacy": "Personvern",
  "settingsV2.tab.capabilities": "Funksjonskonfigurasjon",
  "settingsV2.comingSoon": "Kommer snart",
  "settingsV2.general.title": "Generelle innstillinger",
  "settingsV2.general.section.profile": "Profil",
  "settingsV2.general.row.fullName.title": "Fullt navn",
  "settingsV2.general.row.fullName.description": "Ditt visningsnavn",
  "settingsV2.general.row.fullName.placeholder": "Skriv inn fullt navn",
  "settingsV2.general.row.nickname.title": "Kallenavn",
  "settingsV2.general.row.nickname.description": "Et kort navn vist i sidepanelet",
  "settingsV2.general.row.nickname.placeholder": "Skriv inn kallenavn",
  "settingsV2.general.row.workScene.title": "Arbeidsscenario",
  "settingsV2.general.row.workScene.description": "Ditt primære arbeidsscenario",
  "settingsV2.general.workScene.none": "Ikke angitt",
  "settingsV2.general.workScene.development": "Utvikling",
  "settingsV2.general.workScene.writing": "Skriving",
  "settingsV2.general.workScene.research": "Forskning",
  "settingsV2.general.workScene.design": "Design",
  "settingsV2.general.workScene.other": "Annet",
  "settingsV2.privacy.title": "Personvern",
  "settingsV2.privacy.placeholder": "Personverninnstillinger vil være tilgjengelige i en fremtidig oppdatering.",
  "settingsV2.capabilities.title": "Funksjonskonfigurasjon",
  "settingsV2.capabilities.placeholder": "Funksjonskonfigurasjon vil være tilgjengelig i en fremtidig oppdatering.",
