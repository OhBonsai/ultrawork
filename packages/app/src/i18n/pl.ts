export const dict = {
  ...
  "settingsV2.popover.title": "Ustawienia",
  "settingsV2.popover.settings": "Ustawienia",
  "settingsV2.popover.language": "Zmiana języka",
  "settingsV2.popover.workspace": "Katalog roboczy",
  "settingsV2.popover.providers": "Modele (Dostawcy)",
  "settingsV2.popover.channels": "Kanały wiadomości",
  "settingsV2.popover.remote": "Połączenie zdalne",
  "settingsV2.popover.help": "Dokumentacja pomocy",
  "settingsV2.popover.about": "O nas",
  "settingsV2.popover.comingSoon": "Wkrótce",
  "settingsV2.tab.general": "Ogólne",
  "settingsV2.tab.privacy": "Prywatność",
  "settingsV2.tab.capabilities": "Konfiguracja możliwości",
  "settingsV2.comingSoon": "Wkrótce",
  "settingsV2.general.title": "Ustawienia ogólne",
  "settingsV2.general.section.profile": "Profil",
  "settingsV2.general.row.fullName.title": "Pełne imię i nazwisko",
  "settingsV2.general.row.fullName.description": "Twoje wyświetlane imię i nazwisko",
  "settingsV2.general.row.fullName.placeholder": "Wprowadź pełne imię i nazwisko",
  "settingsV2.general.row.nickname.title": "Pseudonim",
  "settingsV2.general.row.nickname.description": "Krótka nazwa wyświetlana na pasku bocznym",
  "settingsV2.general.row.nickname.placeholder": "Wprowadź pseudonim",
  "settingsV2.general.row.workScene.title": "Scenariusz pracy",
  "settingsV2.general.row.workScene.description": "Twój główny scenariusz pracy",
  "settingsV2.general.workScene.none": "Nie ustawiono",
  "settingsV2.general.workScene.development": "Programowanie",
  "settingsV2.general.workScene.writing": "Pisanie",
  "settingsV2.general.workScene.research": "Badania",
  "settingsV2.general.workScene.design": "Projektowanie",
  "settingsV2.general.workScene.other": "Inne",
  "settingsV2.privacy.title": "Prywatność",
  "settingsV2.privacy.placeholder": "Ustawienia prywatności będą dostępne w przyszłej aktualizacji.",
  "settingsV2.capabilities.title": "Konfiguracja możliwości",
  "settingsV2.capabilities.placeholder": "Konfiguracja możliwości będzie dostępna w przyszłej aktualizacji.",
}
