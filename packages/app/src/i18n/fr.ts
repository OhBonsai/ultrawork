export const dict = {
  ...
  "settingsV2.popover.title": "Paramètres",
  "settingsV2.popover.settings": "Paramètres",
  "settingsV2.popover.language": "Changer de langue",
  "settingsV2.popover.workspace": "Répertoire de travail",
  "settingsV2.popover.providers": "Modèles (Fournisseurs)",
  "settingsV2.popover.channels": "Canaux de messages",
  "settingsV2.popover.remote": "Connexion distante",
  "settingsV2.popover.help": "Documentation d'aide",
  "settingsV2.popover.about": "À propos",
  "settingsV2.popover.comingSoon": "Bientôt disponible",
  "settingsV2.tab.general": "Général",
  "settingsV2.tab.privacy": "Confidentialité",
  "settingsV2.tab.capabilities": "Configuration des capacités",
  "settingsV2.comingSoon": "Bientôt disponible",
  "settingsV2.general.title": "Paramètres généraux",
  "settingsV2.general.section.profile": "Profil",
  "settingsV2.general.row.fullName.title": "Nom complet",
  "settingsV2.general.row.fullName.description": "Votre nom d'affichage",
  "settingsV2.general.row.fullName.placeholder": "Entrez le nom complet",
  "settingsV2.general.row.nickname.title": "Surnom",
  "settingsV2.general.row.nickname.description": "Un nom court affiché dans la barre latérale",
  "settingsV2.general.row.nickname.placeholder": "Entrez le surnom",
  "settingsV2.general.row.workScene.title": "Scénario de travail",
  "settingsV2.general.row.workScene.description": "Votre scénario de travail principal",
  "settingsV2.general.workScene.none": "Non défini",
  "settingsV2.general.workScene.development": "Développement",
  "settingsV2.general.workScene.writing": "Écriture",
  "settingsV2.general.workScene.research": "Recherche",
  "settingsV2.general.workScene.design": "Design",
  "settingsV2.general.workScene.other": "Autre",
  "settingsV2.privacy.title": "Confidentialité",
  "settingsV2.privacy.placeholder": "Les paramètres de confidentialité seront disponibles dans une mise à jour future.",
  "settingsV2.capabilities.title": "Configuration des capacités",
  "settingsV2.capabilities.placeholder": "La configuration des capacités sera disponible dans une mise à jour future.",
}
