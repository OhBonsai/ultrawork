export const dict = {
  ...
  "home.v2.welcome.title": "What can I help you with?",
  "home.v2.welcome.subtitle": "Choose a capability or describe your task below",
  "home.v2.capability.coding.title": "Coding",
  "home.v2.capability.coding.description": "Write, review, and debug code",
  "home.v2.capability.writing.title": "Writing",
  "home.v2.capability.writing.description": "Draft documents, reports, and content",
  "home.v2.capability.analysis.title": "Analysis",
  "home.v2.capability.analysis.description": "Analyze data, research, and problem-solve",
  "home.v2.capability.coding.prompt.1": "Fix a TODO in the codebase",
  "home.v2.capability.coding.prompt.2": "Write unit tests for the user service",
  "home.v2.capability.coding.prompt.3": "Refactor this function to be more readable",
  "home.v2.capability.writing.prompt.1": "Draft a project proposal document",
  "home.v2.capability.writing.prompt.2": "Write a technical blog post",
  "home.v2.capability.writing.prompt.3": "Create API documentation",
  "home.v2.capability.analysis.prompt.1": "Analyze the performance bottlenecks",
  "home.v2.capability.analysis.prompt.2": "Compare different architectural approaches",
  "home.v2.capability.analysis.prompt.3": "Review code for security vulnerabilities",
  "home.v2.composer.placeholder": "Describe your task...",
  "home.v2.composer.start": "Start",
  "home.v2.workspace.label": "Workspace",
  "home.v2.workspace.select": "Select workspace",
  "home.v2.workspace.none": "No workspace selected",
  "home.v2.model.select": "Select model",
  "home.v2.addMenu.title": "Add",
  "home.v2.addMenu.attachFile": "Attach file",
  "home.v2.addMenu.attachImage": "Attach image",
  ...
  // Settings V2
  "settingsV2.tab.general": "General",
  "settingsV2.tab.privacy": "Privacy",
  "settingsV2.tab.capabilities": "Capabilities",
  "settingsV2.comingSoon": "Coming soon",

  "settingsV2.general.title": "General",
  "settingsV2.general.section.profile": "Profile",
  "settingsV2.general.row.fullName.title": "Full name",
  "settingsV2.general.row.fullName.description": "Your full name for display",
  "settingsV2.general.row.fullName.placeholder": "Enter full name",
  "settingsV2.general.row.nickname.title": "Nickname",
  "settingsV2.general.row.nickname.description": "A short name shown in the sidebar",
  "settingsV2.general.row.nickname.placeholder": "Enter nickname",
  "settingsV2.general.row.workScene.title": "Work scene",
  "settingsV2.general.row.workScene.description": "Your primary work scenario",
  "settingsV2.general.workScene.none": "Not set",
  "settingsV2.general.workScene.development": "Development",
  "settingsV2.general.workScene.writing": "Writing",
  "settingsV2.general.workScene.research": "Research",
  "settingsV2.general.workScene.design": "Design",
  "settingsV2.general.workScene.other": "Other",

  "settingsV2.privacy.title": "Privacy",
  "settingsV2.privacy.placeholder": "Privacy settings will be available in a future update.",

  "settingsV2.capabilities.title": "Capabilities",
  "settingsV2.capabilities.placeholder": "Capability configuration will be available in a future update.",

  "settingsV2.popover.title": "Settings",
  "settingsV2.popover.settings": "Settings",
  "settingsV2.popover.language": "Language",
  "settingsV2.popover.workspace": "Workspace",
  "settingsV2.popover.providers": "Models (Providers)",
  "settingsV2.popover.channels": "Message channels",
  "settingsV2.popover.remote": "Remote connection",
