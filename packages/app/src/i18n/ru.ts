export const dict = {
  ...
  "settingsV2.popover.title": "Настройки",
  "settingsV2.popover.settings": "Настройки",
  "settingsV2.popover.language": "Смена языка",
  "settingsV2.popover.workspace": "Рабочая директория",
  "settingsV2.popover.providers": "Модели (Провайдеры)",
  "settingsV2.popover.channels": "Каналы сообщений",
  "settingsV2.popover.remote": "Удалённое подключение",
  "settingsV2.popover.help": "Документация",
  "settingsV2.popover.about": "О нас",
  "settingsV2.popover.comingSoon": "Скоро",
  "settingsV2.tab.general": "Общие",
  "settingsV2.tab.privacy": "Конфиденциальность",
  "settingsV2.tab.capabilities": "Настройка возможностей",
  "settingsV2.comingSoon": "Скоро",
  "settingsV2.general.title": "Общие настройки",
  "settingsV2.general.section.profile": "Профиль",
  "settingsV2.general.row.fullName.title": "Полное имя",
  "settingsV2.general.row.fullName.description": "Ваше отображаемое имя",
  "settingsV2.general.row.fullName.placeholder": "Введите полное имя",
  "settingsV2.general.row.nickname.title": "Псевдоним",
  "settingsV2.general.row.nickname.description": "Короткое имя в боковой панели",
  "settingsV2.general.row.nickname.placeholder": "Введите псевдоним",
  "settingsV2.general.row.workScene.title": "Рабочий сценарий",
  "settingsV2.general.row.workScene.description": "Ваш основной рабочий сценарий",
  "settingsV2.general.workScene.none": "Не задано",
  "settingsV2.general.workScene.development": "Разработка",
  "settingsV2.general.workScene.writing": "Написание",
  "settingsV2.general.workScene.research": "Исследования",
  "settingsV2.general.workScene.design": "Дизайн",
  "settingsV2.general.workScene.other": "Другое",
  "settingsV2.privacy.title": "Конфиденциальность",
  "settingsV2.privacy.placeholder": "Настройки конфиденциальности будут доступны в будущем обновлении.",
  "settingsV2.capabilities.title": "Настройка возможностей",
  "settingsV2.capabilities.placeholder": "Настройка возможностей будет доступна в будущем обновлении.",
}
